...
class Owner < ApplicationRecord
  ...
  def cumulative_stats
    ...
    @away_playoff_games = self.away_fantasy_games.where(week: 14..16, year: 0...2020).or(self.away_fantasy_games.where(week: 15..17, year: 2021...9999))

   

    @home_fantasy_games = self.home_fantasy_games.where(week: 14..16, year: 0...2020).or(self.home_fantasy_games.where(week: 15..17, year: 2021...9999))

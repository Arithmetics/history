json.season_cards @season_card_ownerships do |season_card_ownership|
  ...
  json.extract! season_card_ownership.season_card_effect, :id, :color_one, :color_two, :effect_image_url
  json.set! "effect_name", season_card_ownership.season_card_effect.name
